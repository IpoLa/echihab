...
return (
	...
	<Container style={{ direction: "rtl", marginTop: "50px" }} >
		...
		<Column style={{ direction: "rtl", marginRight: "-100px", width: "200px" }} >
			...
			<Link style={{ textDecoration: "none", color: "white", marginTop: "-20px" }} dir="rtl" to="/">الصفحة الرئيسية</Link>
		...
		<Column style={{ marginRight:"-100px", display: "flex", width: "300px", direction:"rtl" }} >
			<Heading style={{ marginLeft:"100px", direction:"rtl" }}>تابعونا</Heading>
		...
		<Column>
			...
			<FooterLink href="#">
				<p style={{ direction:"rtl", width:"250px", fontSize:"15px" }} >
					وحدة البحث في الوساطة العلمية -CERIST
					جامعة قسطينة 3	
				</p>
				<p style={{ direction:"rtl", width:"250px" }}>
